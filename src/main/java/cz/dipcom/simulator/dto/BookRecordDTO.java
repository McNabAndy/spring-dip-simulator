...
/**
 * BookRecordDTO is a Data Transfer Object (DTO) that represents the data for a book record.
 * It contains various fields that describe the properties of a book, including its metadata,
 * contributors, formats, and related resources. This DTO is used for transferring book record data
 * between different layers of the application (e.g., API responses and requests).
 */
@Getter
@Setter
@NoArgsConstructor
public class BookRecordDTO {
    ...
    /**
     * The unique identifier for the book record.
     */
